...
public class CountryCodeDialog {
    ...
    public static void openCountryCodeDialog(final Signup_Phone codePicker) {
        openCountryCodeDialog(codePicker, null);
    }

    public static void
    openCountryCodeDialog(final Signup_Phone codePicker, final String countryNameCode) {
        context = codePicker.getActivity();
        dialog = new Dialog(codePicker.getActivity());
        ...
        try {
            if (codePicker.getDialogTypeFace() != null) {
                if (codePicker.getDialogTypeFaceStyle() != Signup_Phone.DEFAULT_UNSET) {
