package com.pradeep.hellomedikalpatientapp.Country_Phone_Picker;
...
public class CCPCountry implements Comparable<CCPCountry> {
    ...
    static Signup_Phone.Language loadedLibraryMasterListLanguage;
    ...
    static Signup_Phone.Language getLoadedLibraryMasterListLanguage() {
        return loadedLibraryMasterListLanguage;
    }

    static void setLoadedLibraryMasterListLanguage(Signup_Phone.Language loadedLibraryMasterListLanguage) {
     ...
     */
    static void loadDataFromXML(Context context, Signup_Phone.Language language) {
        ...
        if (countries.size() == 0) {
            loadedLibraryMasterListLanguage = Signup_Phone.Language.ENGLISH;
    ...
    public static String getDialogTitle(Context context, Signup_Phone.Language language) {
    ...
    public static String getSearchHintMessage(Context context, Signup_Phone.Language language) {
    ...
    public static String getNoResultFoundAckMessage(Context context, Signup_Phone.Language language) {
     ...
     */
    public static CCPCountry getCountryForCode(Context context, Signup_Phone.Language language, List<CCPCountry> preferredCountries, String code) {
    ...
    static List<CCPCountry> getCustomMasterCountryList(Context context, Signup_Phone codePicker) {
     ...
     */
    public static CCPCountry getCountryForNameCodeFromCustomMasterList(Context context, List<CCPCountry> customMasterCountriesList, Signup_Phone.Language language, String nameCode) {
     ...
     * or returns null if no country matches given code.
     */
    public static CCPCountry getCountryForNameCodeFromLibraryMasterList(Context context, Signup_Phone.Language language, String nameCode) {
        List<CCPCountry> countries;
     ...
     * or returns null if no country matches given code.
     */
    public static CCPCountry getCountryForCode(Context context, Signup_Phone.Language language, List<CCPCountry> preferredCountries, int code) {
     ...
     */
    public static CCPCountry getCountryForNumber(Context context, Signup_Phone.Language language, List<CCPCountry> preferredCountries, String fullNumber) {
        int firstDigit;
        if (fullNumber == null) {
            return null;
        } else {
     ...
     * null for 2956635321 ( as neither of "2", "29" and "295" matches any country code)
     */
    public static CCPCountry getCountryForNumber(Context context, Signup_Phone.Language language, String fullNumber) {
     ...
     * @return
     */
    public static List<CCPCountry> getLibraryMasterCountryList(Context context, Signup_Phone.Language language) {
